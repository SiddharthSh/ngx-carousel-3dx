...
import { CaraoselOptions, CaraoselSource } from './ngx-carousel-3dx.interface';

@Component({
  selector: 'ngx-carousel-3dx',
  templateUrl: './ngx-carousel-3dx.component.html',
  styleUrls: ['./ngx-carousel-3dx.component.scss'],
  providers: []
})
